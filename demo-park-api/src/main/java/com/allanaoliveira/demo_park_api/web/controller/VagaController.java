...
import com.allanaoliveira.demo_park_api.service.VagaService;
...
import com.allanaoliveira.demo_park_api.web.dto.mapper.VagaMapper;
...
public class VagaController {
   ...
   public ResponseEntity<Void> create(@RequestBody  @Valid VagaCreateDto vagaCreateDto) {
    ...
    public ResponseEntity<VagaResponseDto> getByCodigo(@PathVariable @Valid String codigo) {
        ...
        return ResponseEntity.ok(VagaMapper.toVaga(vaga));
